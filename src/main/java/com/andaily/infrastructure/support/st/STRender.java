...
public class STRender {
    ...
    public String render(Map<String, Object> attributes) {
        ...
        StringTemplateGroup group = new ExtStringTemplateGroup(defaultSTGroupName, suffix);
     ...
     */
    private class ExtStringTemplateGroup extends StringTemplateGroup {

        private String suffix;

        public ExtStringTemplateGroup(String name, String suffix) {
            super(name);
            this.suffix = suffix;
        }
