...
<div class="row">
    ...
    <div class="span8">
        <form action="" id="projectForm" class="form-inline">
            ...
            <spring:message  text="Project cade" var="projectNameMessage"/>
            <input type="text" name="projectCode" value="${projectOverviewDto.projectCode}" placeholder="${projectNameMessage}"/>
