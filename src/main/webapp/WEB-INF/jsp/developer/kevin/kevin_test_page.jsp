...
<form action="${contextPath}/developer/KevinController/test_form_sumit" method="post">
...
<table>
<tr><td>name2 : </td> <td id="name2"></td> </tr>
<tr><td>age2 : </td> <td id="age2"></td> </tr>
<tr><td>gender2 : </td> <td id="gender2"></td> </tr>
</table>

<hr>
<form action="${contextPath}/developer/KevinController/test_find_record" method="post">
...
<script type="text/javascript">
    $(function () {
        console.log("My first front end page!");
        
        $("#myButton1").click(function(){
        	console.log("userName2 = " + $("#userName2").val());
        	console.log("userAge2 = " + $("#userAge2").val());
        	console.log("userGender2 = " + $("#userGender2").val());
        	
        	$.ajax({  
                type : "POST", 
                url : "${contextPath}/developer/KevinController/test_ajax_sumit",
                data : {  
